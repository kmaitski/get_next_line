...
/*   Updated: 2017/04/28 10:28:14 by kmaitski         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* 
 * ===  FUNCTION  ==============================================================
 *         Name:  read_from_the_text_file
 *  Description:  Reads data from the text file into a buffer.
 * =============================================================================
 */
void read_from_the_text_file ( <+argument_list+> )
{
	return <+return_value+>;
}		/* -----  end of function read_from_the_text_file  ----- */
/* 
 * ===  FUNCTION  ==============================================================
 *         Name:  get_next_line
